          ...
          Expanded(
            child: GridView.count(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                            image: NetworkImage(
                                "https://firebasestorage.googleapis.com/v0/b/three-dimension-fitness.appspot.com/o/homeCards%2Fnew%2014.jpg?alt=media&token=f514c0d3-0350-4027-9b0c-231e96bfdddd"),
                            fit: BoxFit.cover)),
                    child:
                        Stack(alignment: Alignment.bottomLeft, children: const [
                      Padding(
                ...
                GestureDetector(
                  onTap: () async {
                    String url = 'https://www.youtube.com/watch?v=JZequ2J7wU0';
                    await launch(url);
                  },
                  child: Container(
                    padding: const EdgeInsets.all(8),
                ...
                GestureDetector(
                  onTap: () async {
                    String url = 'https://www.youtube.com/watch?v=1oed-UmAxFs';
                    await launch(url);
                  },
                  child: Container(
                    padding: const EdgeInsets.all(8),
